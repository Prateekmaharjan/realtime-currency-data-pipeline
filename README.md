...
Analyzes live USD exchange rate movement across 6 currencies (NPR, EUR, 
GBP, JPY, INR, AUD), with a published Tableau dashboard comparing rate 
trends over time. Built on a real-time streaming pipeline — from API 
ingestion to a structured data warehouse — using Apache Kafka, PySpark 
Structured Streaming, and MySQL.
...
- **Exchange rate analysis** — Tableau dashboard comparing rate movement across 6 currencies over time
...
This pipeline mirrors real-world fintech data patterns used in currency exchange and payment processing systems:
